...
export const PERFUMES: Perfume[] = [
  ...
  { code: "CC180", name: "The Most Wanted Parfum", inspiration: "Azzaro", family: "ORIENTAL ESPECIADO", notes: ["CARDAMOMO", "TOFFEE", "MADERA AMBARADA"], intensity: 5, duration: "12h+", gender: "Man", category: "Night", badge: "Bestseller", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775219357/CC180_fjtxba.png" },
  ...
  { code: "CC024", name: "BLEU CHANEL", inspiration: "Chanel", family: "CITRICOS, FRESCO ESPECIADO, BALSAMICO", notes: ["TORONJA", "INCIENSO", "JENGIBRE"], intensity: 4, duration: "10-12h", gender: "Man", category: "Daily", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775219340/CC024_zqos95.png" },
  { code: "CC016", name: "ACQUA DI GIO PROFONDO GIORGIO ARMANI", inspiration: "Giorgio Armani", family: "FRESCO, AMADERADO, CITRICO", notes: ["BERGAMOTA", "ROMERO", "PACHULÍ"], intensity: 4, duration: "10h", gender: "Man", category: "Daily", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775219340/CC016_mdwnkl.png" },
  ...
  { code: "CC059", name: "Gucci Guilty Black Pour Homme", inspiration: "Gucci", family: "AROMATICO, FLOR BLANCO, VERDE", notes: ["NOTAS VERDES", "FLOR DE AZAHAR", "LAVANDA"], intensity: 4, duration: "10h", gender: "Man", category: "Casual", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775224286/CC059_am0wct.png" },
  ...
  { code: "DD096", name: "LIBRE YVES SAINT LAURENT", inspiration: "YSL", family: "FLORAL BLANCO, CITRICO, LAVANDA", notes: ["LAVANDA", "MANDARINA", "VAINILLA"], intensity: 4, duration: "10h", gender: "Woman", category: "Casual", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775219367/DD096_ymvwyq.png" },
  ...
  { code: "DD178", name: "VALENTINO DONNA BORN IN ROMA GREEN STRAVAGANZA", inspiration: "Valentino", family: "ÁMBAR FLORAL AMADERADA", notes: ["TÉ LAPSANG SOUCHONG", "JAZMÍN", "VAINILLA"], intensity: 4, duration: "10h", gender: "Woman", category: "Casual", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775219378/DD178_uozhv0.png" },
  ...
  { code: "DD110", name: "OLYMPEA PACO RABANNE", inspiration: "Paco Rabanne", family: "AVAINILLADO, SALADO, AMADERADO", notes: ["VAINILLA", "SAL", "JAZMIN DE AGUA"], intensity: 4, duration: "10h", gender: "Woman", category: "Casual", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775219384/DD110_itfju7.png" },
  ...
  { code: "DD097", name: "LADY MILLION GOLD", inspiration: "Paco Rabanne", family: "FLORAL FRUTAL", notes: ["FRAMBUESA", "NEROLI", "LIMÓN DE AMALFI"], intensity: 4, duration: "10h", gender: "Woman", category: "Casual", imageUrl: "https://res.cloudinary.com/drtvcb5ei/image/upload/v1775219368/DD097_againj.png" },
